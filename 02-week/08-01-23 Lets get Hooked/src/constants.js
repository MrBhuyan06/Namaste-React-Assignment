...
export const RestoListDummy = [
  {
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/btoyxdvjoaturqeafklv",
    name: "GoFoodtion",
    cusines: ["Biryani", "love"],
    rating: "4",
  },
  {
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/k8o3wnzsep43bftzci8g",
    name: "Truptee",
    cusines: ["indian", "chinese", "Tandorri"],
    rating: "4.5",
  },
  {
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/fkg6i5lscguses9vni6m",
    name: "KAlinga Tribe",
  ...
  {
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/pzjdirj3ylp6pdjkrgzo",
    name: "Sweet Tribe",
    cusines: ["indian", "chinese", "sweety"],
    rating: "3.0",
  },
  {
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/ekyurvwke9nfhzdyikgf",
    name: "Bengali Sweet",
    cusines: ["indian", "chinese"],
    rating: "2.0",
  },
...
export function fliterData(seacrhTxt, resto) {
  const f_Data = resto.filter((resto) => {
    return resto.data.name.includes(seacrhTxt);
  });
  return f_Data;
}
